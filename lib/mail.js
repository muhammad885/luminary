...
export const sendVerificationEmail = async (email, token) => {
  ...
  const logoUrl ="https://res.cloudinary.com/djr7uqara/image/upload/f_auto,q_auto/xtanzam7aw0f7tdfwxlx"
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto;">
            ...
            <tr>
              <td style="padding: 30px 40px; background-color: #ffffff;" class="responsive-padding">
                ...
                <div style="background-color: #f9f9f9; padding: 20px; border-radius: 8px; border-left: 4px solid ${statusColors[newStatus] || '#b8860b'};">
                  ...
                  <p style="margin-bottom: 15px; font-size: 16px;">
                    ...
                    <span style="color: ${statusColors[newStatus] || '#b8860b'}; font-weight: bold;">
                ...
                <p style="font-size: 14px; color: #777; margin-top: 25px;">
                  ...
                  <a href="mailto:support@luminarygiftshop.com" style="color: #b8860b;">support team</a>.
                </p>
              </td>
            </tr>
            ...
            <!-- Footer -->
            <tr>
              <td style="padding: 20px 40px; background-color: #fffaf0; text-align: center;" class="responsive-padding">
                <p style="margin: 0; font-size: 12px; color: #888;">
                  © ${new Date().getFullYear()} Luminary Gifts Store. All rights reserved.
                </p>
              </td>
        ...
        <tr>
          ...
          <td style="padding-left: 20px;" valign="top">
            ...
            <p style="margin: 0 0 8px; color: #666; font-size: 14px;">
              ${product.category || 'Gift Item'}
            </p>
            <p style="margin: 0 0 8px; color: #333;">
              ${product.description ? product.description.substring(0, 100) + (product.description.length > 100 ? '...' : '') : 'A wonderful gift item'}
            </p>
