        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border rounded-lg">
              {[1, 2].map((item) => (
                <div key={item} className="p-4 border-b flex items-center">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${statusDetails.color}`}>
                        {statusDetails.icon}
                      </div>
                      {!isLast && (
                        <div className="absolute left-1/2 top-10 -translate-x-1/2 h-full w-0.5 bg-gray-200"></div>
                      )}
                    </div>
      ...
      <div className="mb-8">
        ...
        <div className="border rounded-lg">
          {order.orderItems.map((item) => (
            <div key={item._id} className="p-4 border-b flex items-center">
              <div className="mr-4">
